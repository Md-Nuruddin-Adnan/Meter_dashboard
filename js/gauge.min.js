(function () {
  ...
  !(function () {
      ...
      (v.prototype.setOptions = function (t) {
          return (
              null == t && (t = null), (this.options = c(this.options, t)), this.textField && (this.textField.el.style.fontSize = t.fontSize + "px"), 0.5 < this.options.angle && (this.options.angle = 0.5), this.configDisplayScale(), this
          );
      }),
      ...
      (w.prototype.value = 0),
      (w.prototype.options = { strokeWidth: 0.035, length: 0.1, color: "#000000", iconPath: null, iconScale: 1, iconAngle: 0 }),
      ...
      (M.prototype.setOptions = function (t) {
          ...
          for (
              null == t && (t = null),
                  ...
                  this.extraPadding = 0,
                  this.options.angle < 0 && ((n = Math.PI * (1 + this.options.angle)), (this.extraPadding = Math.sin(n))),
      ...
      (M.prototype.set = function (t) {
          ...
          if (t.length > this.gp.length) for (e = n = 0, r = t.length - this.gp.length; 0 <= r ? n < r : r < n; e = 0 <= r ? ++n : --n) (i = new p(this)).setOptions(this.options.pointer), this.gp.push(i);
          else t.length < this.gp.length && (this.gp = this.gp.slice(this.gp.length - t.length));
          for (a = e = 0, o = t.length; a < o; a++)
              (l = t[a]) > this.maxValue ? (this.options.limitMax ? (l = this.maxValue) : (this.maxValue = l + 1)) : l < this.minValue && (this.options.limitMin ? (l = this.minValue) : (this.minValue = l - 1)),
                  (this.gp[e].value = l),
                  this.gp[e++].setOptions({ minValue: this.minValue, maxValue: this.maxValue, angle: this.options.angle });
          ...
          for (
              ...
              void 0 !== (d = p[a]).label
                  ? (!this.options.limitMin || d >= this.minValue) &&
                    ...
                    this.ctx.rotate(u),
                    this.ctx.fillText(g(d.label, t.fractionDigits), 0, -s - this.lineWidth / 2),
                    this.ctx.rotate(-u))
                  : (!this.options.limitMin || d >= this.minValue) &&
                    (!this.options.limitMax || d <= this.maxValue) &&
                    ((u = this.getAngle(d) - (3 * Math.PI) / 2), this.ctx.rotate(u), this.ctx.fillText(g(d, t.fractionDigits), 0, -s - this.lineWidth / 2), this.ctx.rotate(-u));
          ...
          if (
              ...
              for (this.ctx.save(), this.ctx.translate(g, e), this.ctx.lineWidth = this.lineWidth, s = 0, o = (p = this.options.staticZones).length; s < o; s++)
                  (r = (m = p[s]).min),
                      ...
                      m.height && ((this.ctx.lineWidth = this.lineWidth * m.height), (u = (this.lineWidth / 2) * (m.offset || 1 - m.height)), (d = this.radius * this.options.radiusScale + u)),
              ...
              void 0 !== this.options.customFillStyle
                  ...
                  ? ((i = 0 === this.options.gradientType ? this.ctx.createRadialGradient(g, e, 9, g, e, 70) : this.ctx.createLinearGradient(0, 0, g, 0)).addColorStop(0, this.options.colorStart), i.addColorStop(1, this.options.colorStop))
      ...
      (C.prototype.options = { lineWidth: 0.1, colorStart: "#6f6ea0", colorStop: "#c0c0db", strokeColor: "#eeeeee", shadowColor: "#d5d5d5", angle: 0.35, radiusScale: 1 }),
      ...
      (C.prototype.setOptions = function (t) {
          return (
              null == t && (t = null), C.__super__.setOptions.call(this, t), (this.lineWidth = this.canvas.height * this.options.lineWidth), (this.radius = this.options.radiusScale * (this.canvas.height / 2 - this.lineWidth / 2)), this
          );
      }),
      ...
      (C.prototype.render = function () {
          ...
          return (
              ...
              this.textField && this.textField.render(this),
              (i = this.ctx.createRadialGradient(s, e, 39, s, e, 70)).addColorStop(0, this.options.colorStart),
              ...
              (this.ctx.strokeStyle = this.options.strokeColor),
              this.ctx.beginPath(),
              this.ctx.arc(s, e, this.radius, (1 - this.options.angle) * Math.PI, (2 + this.options.angle) * Math.PI, !1),
              (this.ctx.lineWidth = this.lineWidth),
      ...
      "function" == typeof window.define && null != window.define.amd
          ...
          ? (module.exports = { Gauge: o, Donut: n, BaseDonut: e, TextRenderer: a })
